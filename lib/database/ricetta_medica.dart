...
RicettaList ricettaListFromJson(String str) => RicettaList.fromJson(json.decode(str));
...
class RicettaList {
    ...
    factory RicettaList.fromJson(Map<String, dynamic> json) => RicettaList(
        items: json["items"] == null ? [] : List<Ricetta>.from(json["items"]!.map((x) => Ricetta.fromJson(x))),
    );
