...
PrenotazioneList prenotazioneListFromJson(String str) =>
    PrenotazioneList.fromJson(json.decode(str));

String prenotazioneListToJson(PrenotazioneList data) =>
...
class PrenotazioneList {
  ...
  factory PrenotazioneList.fromJson(Map<String, dynamic> json) =>
      PrenotazioneList(
        items: json["items"] == null
            ? []
            : List<Prenotazione>.from(
                json["items"]!.map((x) => Prenotazione.fromJson(x))),
      );
