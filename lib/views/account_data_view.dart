          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                decoration: const InputDecoration(label: Text("Codice Fiscale"), prefixIcon: Icon(Icons.verified_user), floatingLabelBehavior: FloatingLabelBehavior.always, filled: true),
              ),
              ...
              TextField(
                ...
                readOnly: true,
                canRequestFocus: false,
                decoration: const InputDecoration(label: Text("Nome"), floatingLabelBehavior: FloatingLabelBehavior.always, prefixIcon: Icon(Icons.abc),filled: true),
              ),
              SizedBox(height: size.height * 0.03),
              TextField(
                ...
                readOnly: true,
                canRequestFocus: false,
                decoration: const InputDecoration(label: Text("Cognome"), floatingLabelBehavior: FloatingLabelBehavior.always, prefixIcon: Icon(Icons.abc), filled: true),
              ),
              SizedBox(height: size.height * 0.03),
              TextField(
                ...
                readOnly: true,
                canRequestFocus: false,
                decoration: const InputDecoration(label: Text("Data di Nascita"), floatingLabelBehavior: FloatingLabelBehavior.always, prefixIcon: Icon(Icons.date_range), filled: true)
              ),
              SizedBox(height: size.height * 0.03),
              TextField(
                ...
                readOnly: true,
                canRequestFocus: false,
                decoration: InputDecoration(label: const Text("Genere"), floatingLabelBehavior: FloatingLabelBehavior.always, prefixIcon: genereIcon, filled: true),
              )
            ],
          ),
        ),
