...
class _AccediScreenState extends State<SplashScreen> with SingleTickerProviderStateMixin{
  @override
  void initState(){ // scompaiono i bottoni di sistema
    super.initState();
  ...
  @override
  void dispose(){ //riappaiono i bottoni di sistema
