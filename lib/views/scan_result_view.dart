...
class ResultScreen extends StatefulWidget {
  final String nome, cognome, CF, impegnativa, prescrizione, auth, esenzione, codice_asl, data;
...
TextEditingController codice_autenticazione_Controller = TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        style: TextStyle(color: AppColors.oro, 
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          CustomTextFormField(
                            floatingLabelBehavior: FloatingLabelBehavior.always,
                            textInputAction: TextInputAction.next,
                            labelText: 'Codice ASL (Sigla Provincia + Codice di 3 cifre)',
                            keyboardType: TextInputType.text,
                          ...
                          CustomTextFormField(
                            ...
                            validator: (value) {
                              ...
                              if(!RegExp(r"(3[01]|[12][0-9]|0?[1-9])(\/|-)(1[0-2]|0?[1-9])\2([0-9]{2})?[0-9]{2}").hasMatch(value)){
                          ...
                          CustomTextFormField(
                            ...
                            validator: (value) {
                              ...
                              if(!RegExp(r"([A-Z]{1}\d{2})|([A-Za-z ]+)|(\d{3})").hasMatch(value)){
